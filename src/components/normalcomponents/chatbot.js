...
const Chatbot = () => {
  ...
  return (
    <div className="flex justify-center items-center h-[80%] bg-gray-100 bg-gradient-to-r from-green-100 to-blue-100">
      <div className="w-[400px] h-[100%] bg-white rounded-lg shadow-lg flex flex-col overflow-hidden">
        {/* Header */}
